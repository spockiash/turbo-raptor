...
const baseStyles = "items-center justify-center rounded-md text-sm font-medium transition";
...
// Define CardProps with proper typing
...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className = "", ...props }, ref: any) => {
    return (
      <div
        ref={ref as React.Ref<HTMLDivElement>} // ✅ Properly type `ref`
        className={clsx("p-4 border rounded-md shadow-sm bg-white", className)}
        {...props}
      />
    );
  }
